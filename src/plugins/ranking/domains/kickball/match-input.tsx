...
export function KickballMatchInput({
  scores,
  onScoresChange,
  validationError,
}: MatchInputProps) {
    ...
    <div className="space-y-3">
      <div className="flex items-center gap-3 justify-center">
        <div className="flex flex-col items-center gap-1">
          <span className="text-xs text-muted-foreground">Team 1 Runs</span>
          <Input
            type="number"
            min={0}
        ...
        <div className="flex flex-col items-center gap-1">
          <span className="text-xs text-muted-foreground">Team 2 Runs</span>
          <Input
            type="number"
            min={0}
