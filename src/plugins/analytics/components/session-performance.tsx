...
import { Calendar, TrendingUp, UserX, Info } from "lucide-react"
...
export function SessionPerformance({ days, activityId }: { days: TimeRange; activityId?: string }) {
  const { data, isLoading } =
    trpc.plugin.analytics.sessionPerformance.useQuery({ days, activityId })
